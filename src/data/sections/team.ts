import type { TeamData, TeamDataBasic, TeamMember, TeamMemberBasic } from "../../types/sections/team";
...
const fullMembersData: TeamMember[] = [
  {
    ...
    portfolio: [
      {
        title: "株式財務分析アプリ",
        description: "高配当株投資で培った経験を活かした財務分析ツール。投資判断をサポートする機能を実装。",
      ...
      {
        title: "農業支援システム",
        description: "農業従事者向けの業務効率化システム。IoTデータと連携した管理ツール。",
      ...
      {
        title: "LLM/AIサービス",
        description: "現在開発中の最新AI技術を活用したサービス。ユーザー体験の向上を目指す。",
  ...
  },
  {
    ...
    portfolio: [
      {
        title: "3Dプリンタ作品",
        description: "オリジナルデザインの3Dプリンタ作品集。機能性とデザイン性を両立したハンドメイド作品。",
      ...
      {
        title: "家電制御システム",
        description: "家庭用電化製品の制御プログラム開発。洗濯機や充電器などの組み込みソフトウェア。",
  ...
  },
  {
    ...
    portfolio: [
      ...
      },
      {
        ...
        description: "現在担当している住宅業界向けのWebアプリケーション。フロントエンド開発を中心に、ユーザビリティを重視したUI/UX設計。",
  ...
  },
  {
    ...
    portfolio: [
      {
        title: "社内ツール開発",
        description: "VBAを活用した業務効率化ツール。複雑なデータ処理を自動化し、チームの生産性向上に貢献。",
      ...
      {
        title: "機械設計プロジェクト",
        description: "機械設計エンジニアとしての設計案件。技術的な課題解決と品質向上を実現。",
  ...
  },
  {
    ...
    portfolio: [
      {
        title: "ハンドメイドかごバッグ",
        description: "オリジナルデザインのかごバッグ作品集。実用性とデザイン性を兼ね備えた手作り作品を制作・販売。",
      ...
      {
        title: "機械設計案件",
        description: "建築設計から機械設計への転職を活かした設計業務。多角的な視点でのものづくりを実践。",
      ...
      {
        title: "ものづくりワークショップ",
        description: "子育て経験を活かした、親子で楽しめるものづくりワークショップの企画・運営。",
...
// ホーム用の簡易メンバーデータ
export const basicMembersData: TeamMemberBasic[] = fullMembersData.map(member => ({
  name: member.name,
  title: member.title,
...
const extendedMemberData: { [key: string]: Partial<TeamMember> } = {
  "ももちこ": {
    ...
    description: "鳶職からIT業界への華麗なる転職！プログラミングで人生が変わった経験を、次は誰かに届けたいと考えています！",
    details: [
      {
        icon: "🏗️",
    ...
    message: "重い鉄骨からキーボードへ！プログラミングで人生が180度変わりました。未経験からでも絶対にエンジニアになれる！その経験とノウハウを次は誰かに届けたいと考えています🚀",
  }
};
