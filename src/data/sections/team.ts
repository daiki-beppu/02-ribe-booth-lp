...
export const teamData: TeamData = {
  ...
  description:
    "異業種の現役専門家が集結！動画や書籍では学べない生きた情報とスキルアップのコツをお伝えします",
  members: [
    {
      name: "トムランド",
      title: "投資おたくエンジニア",
      ...
      description: "フェスのプログラム体験会/相談会を通じて学びの楽しさを伝えたいです！",
      color: "orange",
      badge: "リーダー",
      isLeader: true,
      colSpan: 2,
      details: [
        ...
        { icon: "📱", text: "副業実績：株式財務分析アプリ・農業支援システム・プログラム教育で収益化" },
        { icon: "🤖", text: "現在LLM/AIサービス開発中" },
        { icon: "💰", text: "高配当株投資で資産4桁＋配当3桁達成" }
      ],
      message: "フェスのプログラム体験会/相談会を通じて学びの楽しさを伝えたいです！"
    },
    {
      name: "まるの",
      title: "家電エンジニア",
      ...
      details: [
        ...
        { icon: "🏠", text: "ご家庭にある洗濯機、充電器などの中身をプログラミングで作っています" }
      ],
    ...
    },
    {
      ...
      description: "プログラミングで人生が変わった経験を、次は誰かに届けたいと考えています！",
      color: "pink",
      avatar: "/images/icons/momochico-icon.jpg",
      details: [
        { icon: "💻", text: "新しいテクノロジーが大好きな駆け出しプログラマー" },
        { icon: "🚀", text: "2024年10月に転職し、自由な働き方と充実した毎日を実現" },
        { icon: "🌐", text: "現在はWebアプリ開発に携わりつつ、パーソナルAIの開発に挑戦中" }
      ],
      message: "プログラミングで人生が変わった経験を、次は誰かに届けたいと考えています！"
    },
    {
      name: "KOBA",
      ...
      description: "どんな変態エンジニアかを知りたい方は、どしどし話し掛けてくださいね！",
      color: "green",
      ...
      details: [
        ...
        { icon: "😅", text: "小学校の通知表には「情緒不安定」と書かれちゃうほど、落ち着きがない" }
      ],  
      message: "どんな変態エンジニアかを知りたい方は、どしどし話し掛けてくださいね！"
    },
    {
      name: "snowdrop",
      ...
      details: [
        { icon: "👩‍👦‍👦", text: "男子2人を育てるシングルマザーで、会社員・家事・副業をこなすスーパー母ちゃん！" },
  ...
  finalMessage: {
    ...
    description: "日常生活では絶対に出会えない人と知り合い、一緒に何かを成し遂げる仲間との出会いを大切にしています。\nプログラミングを通じて、新しいつながりと可能性を一緒に見つけましょう！"
  }
};
