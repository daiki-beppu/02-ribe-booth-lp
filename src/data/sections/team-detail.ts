    ...
    portfolio: [
      {
        title: '機械設計',
        description:
          '空調機の機械詳細設計を行なっています！ミリ単位での板金や鋼材の設計が得意分野です。設計業務に興味のある方はぜひご相談ください。',
        technologies: ['機械設計', '空調機設計', '板金設計', '鋼材設計'],
        type: 'portfolio',
      },
      {
        title: '2DCAD',
        description:
          '2次元CADソフトをメインで使用しています！外形図、詳細図面の作成が得意です。CADオペレータを目指される方のご相談も承ります。',
        technologies: ['2次元CAD', '図面作成', '外形図', 'CADオペレータ'],
        type: 'portfolio',
      },
      {
        title: '3DCAD',
        description:
          '最近は3次元CADも学習中！立体的な設計やレイアウト設計にチャレンジしています。一緒に学びたい方も大歓迎です！',
        technologies: ['3次元CAD', '立体設計', 'レイアウト設計', '学習中'],
        type: 'portfolio',
      },
      {
        title: '制作ツール紹介',
        description:
          'VBAやアプリ開発、AI等を使用したPC業務効率化を行なっています。お困りごとがあれば、何でもご相談ください！アイデア出しは任せてください！',
        technologies: ['VBA', 'アプリ開発', 'AI活用', '業務効率化'],
        type: 'portfolio',
      },
    ],
  },
